...
class <?= $class_name; ?> extends Exception
{
    ...
    {
        $message = sprintf('<?= $entity_config->entityName; ?>Domain for <?= $entity_config->entityName; ?> with ID %d and domain ID %d not found.', $<?= lcfirst($entity_config->entityName); ?>Id, $domainId);
